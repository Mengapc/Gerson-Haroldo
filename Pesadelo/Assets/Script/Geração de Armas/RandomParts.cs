...
public class RandomParts : MonoBehaviour
{
    ...
    public GameObject GeneratePrincipalPartArm(Armas.ItemType itemType, Transform armBase)
    {
        ...
        switch (itemType)
        {
            ...
            default:
                Debug.LogWarning("Tipo de item n�o suportado.");
                return null;
        }
    ...
    public void GenerationOutherParts(Armas.ItemType itemType, GameObject newItem, Armas.Rarity rarity)
    {
        ...
        if (infoItem == null)
        {
            Debug.LogError($"O objeto principal '{newItem.name}' n�o possui o script 'LockParts'!", newItem);
            return;
        }
        ...
        switch (itemType)
        {
            case Armas.ItemType.Sword:
                ...
                // Opcional mas recomendado: resetar posi��o local ap�s instanciar com pai.
