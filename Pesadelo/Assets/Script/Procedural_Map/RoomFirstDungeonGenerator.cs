...
public class RoomFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    private float removalChance = 0.4f; // Chance de remover salas ap�s a gera��o

    [SerializeField]
    private int spacingMargin = 2; // Espa�o extra entre as salas
    ...
    private void CreateRooms()
    {
        ...
        // Certificando-se de que o tamanho da dungeon est� correto
        ...
        // Aplica um espa�amento extra entre salas
        roomsList = ApplySpacing(roomsList, spacingMargin);

        Debug.Log($"N�mero de salas geradas ap�s filtragem: {roomsList.Count}");
        ...
        // Pinta o ch�o e cria as paredes
